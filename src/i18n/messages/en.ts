...
export const en = {
  ...
  customers: {
    ...
    list: {
      ...
      filters: {
        ...
        filter: "Filter",
        where: "Where",
        birthDateAfterPrefix: "Birth date is after",
      },
    },
    columnPresets: {
      title: "Editing custom clients preset",
      subtitle: "Customise your view by selecting and ordering the columns you want to see.",
      availableHeading: "Available columns",
      selectedHeading: "Selected columns",
  ...
  branches: {
    title: "Branches",
    subtitle:
      "Organizational units for operational segmentation, access control and branch-level accounting.",
    ...
    searchPlaceholder: "Search branch by name, ID or region...",
    table: {
      id: "ID",
      name: "Branch",
      type: "Type",
    ...
    detail: {
      ...
      segmentedAccounting: "Segmented accounting",
      assignments: "Assignments",
      accountingYes: "Enabled",
      accountingNo: "Not enabled",
      manageCalendar: "Manage calendar",
      editBranch: "Edit branch",
    },
    assignmentsSummary: "{clients} clients, {groups} groups, {users} users",
    emptySelect: "Select a branch to see details.",
  },
  productsScreen: {
    title: "Products",
    subtitle:
    ...
    detail: {
      ...
      subtitleDeposit: "Funding template · ID {id}",
      subtitleLoan: "Lending template · ID {id}",
      emptyHint: "Select a product to see its full configuration.",
      amountRules: "Amount rules: {min} to {max}",
      rateRange: "Rate range: {min}% to {max}%",
      deposit: {
        productType: "Product type",
        interestSettings: "Interest rate settings",
        overdraft: "Overdraft",
        overdraftYes: "Allowed (limit {limit})",
        overdraftNo: "Not allowed",
      },
      loan: {
        paymentMethod: "Payment method",
        grace: "Grace period",
        graceValue: "{n} installments",
        schedule: "Repayment schedule",
        scheduleValue: "{frequency} · up to {max} installments",
        collateral: "Collateral",
        collateralYes: "Collateral required",
        collateralNo: "No collateral",
      },
    },
    modal: {
      ...
      depositProductType: "Product type",
      ...
      graceInstallments: "Grace installments",
      maxInstallments: "Maximum installments",
    ...
    enums: {
      ...
      paymentMethod: {
        EQUATED_INSTALLMENTS: "Equal installments",
    ...
    validation: {
      ...
      amountRange: "Invalid amount range.",
      rateRange: "Invalid rate range.",
      maxInstallments: "Invalid maximum installments.",
      overdraftLimit: "If overdraft is enabled, set a limit greater than 0.",
    },
  },
